...
CREATE TABLE Purchases (
    ...
    FOREIGN KEY (CarpetID) REFERENCES Carpet_Inventory
);
...
CREATE TABLE Carpet_Trials (
    ...
    Reservvation_Act_Return_Date    VARCHAR(50),
    FOREIGN KEY (CustomerID) REFERENCES CustomerInfo,
    FOREIGN KEY (CarpetID) REFERENCES Carpet_Inventory
);  
...
INSERT INTO Carpet_Trials (CustomerID, CarpetID,Reservation_Start_Date,Reservation_Exp_Return_Date,Reservvation_Act_Return_Date)
