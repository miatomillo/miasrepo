<?php
        ...
        // Prepare statements for inital order creation...
   ...
   <?php
       ...
       foreach( $dishes_ordered as $dish_name => $dish_qant){
           if(!$order_exists){
               ...
               // var_dump($cust_recent_order_res); // Empty set
               $cust_recent_order_row = $cust_recent_order_res->fetch_array();
               // var_dump($cust_recent_order_row); // NULL
